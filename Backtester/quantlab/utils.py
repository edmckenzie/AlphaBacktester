...
class Alpha():
    ...
    def get_hypothesis_tests(self,zfs=None,num_decision_shuffles=500,num_data_shuffles=20):
        import quantlab.quant_stats as quant_stats
    ...
    def compute_meta_info(self,trade_range):
        ...
        for inst in self.insts:
            ...
            inst_vol = (-1 + self.dfs[inst]["close"]/self.dfs[inst]["close"].shift(1)).rolling(10).std()
